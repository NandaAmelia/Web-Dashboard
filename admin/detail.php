...
<div class="container p-2">
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
    ...
    if($hitungcocok==0){
      ...
      echo "DISEWA";
             ...
             <a href="index.php?halaman=edit_lokasi&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Lokasi</a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
       <svg xmlns="http://www.w3.org/2000/svg" width="1.75em" height="1.75em" fill="currentColor" class="bi text-muted flex-shrink-0 me-3" viewBox="0 0 16 16">
 ...
 <a href="index.php?halaman=edit_hostname&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Informasi Hostname</a>
          </p>
        </div>
      </div>
...
?>
           ...
           <a href="index.php?halaman=edit_kelistrikan&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Kelistrikan</a>
        </div>
      </div>
...
if($hitungsingle==0){ ?>
  ...
  <h4 class="fw-bold mb-0">SINGLE SOURCE A</h4>
          ...
          <a href="index.php?halaman=edit_source&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Source</a>
        </div>
      </div>
              <?php
 ...
 <?php
  ...
  if($detailhostname['kebutuhan_pln']== 'TIDAK PERLU' || $detailhostname['kebutuhan_pln']== 'NOK' || $detailhostname['kebutuhan_pln']== 'KENDALA' ){?>
    <h4 class="fw-bold mb-0">ONT ALARM PLN DOWN</h4>
          <p><table class="table table-border table-striped" style="font-size: .75rem;">
              <tr>
                <th><b>DALAM Status TIDAK PERLU  NOK atau KENDALA </b></th>
                <td></td>
                <td></td>
              </tr>
            </table>
...
<h4 class="fw-bold mb-0">ONT ALARM PLN DOWN</h4>
          <p><table class="table table-border table-striped" style="font-size: .75rem;">
            ...
            <a href="index.php?halaman=edit_ont&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah ONT ALARM PLN</a>
          </p>
...
<h5 class="fw-bold mb-0">UPLINK OLT </h>
          <p><table class="table table-border table-striped" style="font-size: .75rem;">
            ...
            <a href="index.php?halaman=edit_uplink&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Uplink</a>
          </p>
...
<?php }?>
    ...
    <a href="index.php?halaman=edit_non_sto&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Fasilitas Non STO</a>
        </div>
      </div>
...
<?php }else{?>
    ...
    <a href="index.php?halaman=edit_keamanan&id=<?php echo $id ?>" class="btn btn-success btn-sm">Ubah Keamanan</a>
        </div>
      </div>
