...
<div class="container col-5 p-5 mt-5 rounded-3">
  <div class="alert alert-info text-center bg-opacity-75"><h3>Witel dan STO  Belum Disisi. <a href="index.php?halaman=edit_lokasi&id=<?php echo($id) ?>" class="link-danger">Lengkapi Witel</a></h3></div>
</div>
<?php else: ?>
