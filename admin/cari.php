<title>Hostname</title>
    <div class="p-5"></div>
      ...
      <div class="table-responsive m-3">
        <span class="fs-4 ps-2 text-primary mb-lg-0"><strong>Hostname</strong></span>
        <div class="col-md-4">
...
<a class="btn btn-primary btn-sm container mb-4" href="index.php?halaman=tambahhostname"><b>Tambah Hostname</b></a></div>
   ...
   $batas=20;
    ...
    while($hostname = mysqli_fetch_assoc($ambil)){ ?>
      <tr>
        ...
        <td>        
          <a class="btn btn-primary btn-sm" href="index.php?halaman=detail&id=<?php echo $hostname['id_ip'] ?>">Detail</a>
        </td>
        <td>
          <a class="btn btn-danger btn-sm" href="index.php?halaman=hapus_hostname&id=<?php echo $hostname['id_ip'] ?>">
<svg class="bi" width="18" height="18"><path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/><path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
</svg>
          </button>
        </td>
      </tr>
   ...
   <ul class="pagination justify-content-center">
    <?php
      ...
      <?php
          ...
          ?>
            <li class="page-item">
      <a class="page-link"  href="index.php?halaman=cari&page=<?php echo $mundur;?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
       <?php     
        ...
        ?> 
        <li class="page-item">
      <a class="page-link" href="index.php?halaman=cari&page=<?php echo $mundur;?>&Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
         <?php
    ...
    <!-- link Next Page -->
      ...
      elseif($page < $jumlah_halaman){
       if($kolomCari=="" && $kolomKataKunci==""){
          ?>
            <li class="page-item">
      <a class="page-link" href="index.php?halaman=cari&page=<?php echo $maju;?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
       <?php     
        ...
        ?> 
        <li class="page-item">
      <a class="page-link" href="index.php?halaman=cari&page=<?php echo $maju;?>&Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
      <?php
