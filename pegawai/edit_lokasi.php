...
<div class="container col-5 p-5 mt-5 rounded-3">
  <div class="alert alert-info text-center bg-opacity-75"><h3>Witel dan STO  Sudah Disisi. <a href="edit_lokasi1.php?id=<?php echo($id) ?>" class="link-danger">Lengkapi Alamat</a></h3></div>
</div>
<?php endif ?>
<?php
if (isset($_POST['selanjutnya'])) {
  ...
  echo "<script>location='edit_lokasi.php?id=$id';</script>"; 
          ...
          echo "<script>location='edit_lokasi1.php?id=$id';</script>"; 
